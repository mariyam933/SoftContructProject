...
public class ProductFrame extends javax.swing.JFrame {
    ...
    public ProductFrame(ArrayList<Product> p, int id, Customer cs) {
        ...
        ImageIcon background_img = new ImageIcon(
                "C:\\Users\\MINAHIL SHAKOOR\\Downloads\\Grocery_Management_System_Java\\SMMS_Images\\SMMS_Images\\productBG.png", "");
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Hubballi", 1, 14)); // NOI18N
        jLabel1.setText("Name:");

        jLabel2.setFont(new java.awt.Font("Hubballi", 1, 14)); // NOI18N
        jLabel2.setText("Description:");

        priceLabel.setFont(new java.awt.Font("Hubballi", 0, 14)); // NOI18N
        priceLabel.setText("productPrice");

        nameLabel.setFont(new java.awt.Font("Hubballi", 0, 14)); // NOI18N
        nameLabel.setText("productName");

        jLabel3.setFont(new java.awt.Font("Hubballi", 1, 14)); // NOI18N
        jLabel3.setText("Price:");

        descArea.setEditable(false);
        descArea.setColumns(20);
        descArea.setFont(new java.awt.Font("Didot", 0, 14)); // NOI18N
        descArea.setRows(5);
        descArea.setText("product description here");
        jScrollPane1.setViewportView(descArea);

        addToCartBtn.setBackground(new java.awt.Color(255, 128, 112));
        addToCartBtn.setFont(new java.awt.Font("Hoefler Text", 1, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(imageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 342, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(250, 250, 250)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(55, 55, 55)
                        .addComponent(imageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 524, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(123, 123, 123)
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
